...
!
        ...
        NAMELIST / control / title, calculation, verbosity, restart_mode, &
          ...
          tqmmm, trism, vdw_table_name, lorbm, memory, point_label_type,  &
...
!
        ...
        INTEGER :: mdiis1d_size = 20
          ! size of MDIIS algorism in 1D-RISM calculation

        INTEGER :: mdiis3d_size = 10
          ! size of MDIIS algorism in 3D-RISM calculation

        REAL(DP) :: mdiis1d_step = -1.0_DP
          ! step width of MDIIS algorism in 1D-RISM calculation

        REAL(DP) :: mdiis3d_step = -1.0_DP
          ! step width of MDIIS algorism in 3D-RISM calculation
