...
CONTAINS
  ...
  SUBROUTINE write_3drism_x(rismt, nr, nsite, zr, ecut, file_base, name)
    ...
    CALL write_3drism_xml(file_base, zr(1:nr, 1:nsite), name, &
                        ...
                        & ecut, rismt%cfft%dfftt%nr1, rismt%cfft%dfftt%nr2, rismt%cfft%dfftt%nr3, &
                        & rismt%cfft%dfftt%nr1x, rismt%cfft%dfftt%nr2x, &
                        & rismt%cfft%dfftt%ipp, rismt%cfft%dfftt%npp, ionode, &
