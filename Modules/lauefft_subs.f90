...
SUBROUTINE set_lauefft_offset0_x(lauefft0, wright1, wright2, wleft1, wleft2)
  ...
  IF (wright2 /= 0.0_DP) THEN
    nright2 = NINT((wright2 - 0.5_DP * at(3, 3)) / lauefft0%zstep)
  END IF
  !
  IF (lauefft0%xright) THEN
    lauefft0%izright_start0 = lauefft0%izcell_start + lauefft0%dfft%nr3 / 2
    lauefft0%izright_start0 = lauefft0%izright_start0 + nright1
    lauefft0%izright_start0 = MAX(lauefft0%izright_start0, lauefft0%izcell_start)
    !
    lauefft0%izright_end0 = lauefft0%izcell_end + nright2
  ...
  IF (wleft2 /= 0.0_DP) THEN
    nleft2 = NINT((wleft2 + 0.5_DP * at(3, 3)) / lauefft0%zstep)
  END IF
  !
  IF (lauefft0%xleft) THEN
    IF (lauefft0%xright) THEN
    ...
    !
    lauefft0%izleft_start0 = lauefft0%izcell_start + nleft2
