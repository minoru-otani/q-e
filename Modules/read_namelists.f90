...
!=======================================================================
     ...
     SUBROUTINE fcp_defaults( prog, ions_are_set )
       ...
       IF ( .NOT. ions_are_set ) THEN
          !
          ! ... ( 'none' | 'lm' | 'mdiis' | 'bfgs' | 'damp' | 'verlet' )
          !
          fcp_dynamics = 'none'
          !
       END IF
       ...
       fcp_relax_step  = -1.0_DP  ! will initialize at iosys_fcp
       fcp_mdiis_size  = 4
...
!
     ...
     SUBROUTINE fcp_checkin( prog )
       ...
       !
       !IF( fcp_relax_step <= 0.0_DP ) &
       !   CALL errore( sub_name,' fcp_relax_step out of range ', 1 )
       !
       IF( fcp_mdiis_size <= 0 ) &
